...
export ZSH="/home/jhrenyk/.oh-my-zsh"
...
# oh-my-zsh Aliases
alias cheatsheet-nmap="less ~/.oh-my-zsh/plugins/nmap/README.md"
alias cheatsheet-cp="less ~/.oh-my-zsh/plugins/cp/README.md"
alias cheatsheet-alias="less ~/.oh-my-zsh/plugins/common-aliases/README.md"
alias cheatsheet-rsync="less ~/.oh-my-zsh/plugins/rsync/README.md"
...
if [ "$TERM" = "linux" ]; then
    ...
    echo -en "\e]P9dc322F" #red
    echo -en "\e]P287AF5F" #darkgreen
    echo -en "\e]PA859900" #green
    echo -en "\e]P3D7AF87" #brown
    echo -en "\e]PBB58900" #yellow
    echo -en "\e]P48787AF" #darkblue
    echo -en "\e]PC268BD2" #blue
    echo -en "\e]P5BD53A5" #darkmagenta
    echo -en "\e]PDD33682" #magenta
    echo -en "\e]P65FAFAF" #darkcyan
    echo -en "\e]PE2AA198" #cyan
    echo -en "\e]P7839496" #lightgrey
